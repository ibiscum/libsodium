...
main(void)
{
  ...
  assert(crypto_auth_hmacsha512_statebytes() == sizeof(crypto_auth_hmacsha512_state));
  ...
  assert(crypto_auth_hmacsha512256_statebytes() >= crypto_auth_hmacsha512256_keybytes());
